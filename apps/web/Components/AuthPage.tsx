        ...
        <div className="h-[98svh] p-2">
            ...
            ">
                ...
                <div className="flex flex-col p-2 border border-gray-700 rounded-md" >
                    ...
                    {!isSignin&&<Input ref={FirstNameRef} placeholder="First name" type="text" ></Input>}
                    {!isSignin&&<Input ref={LastNameRef} placeholder="Last name" type="text" ></Input>}


                    <Input ref={emailRef}  placeholder={"Email"} type={"email"} ></Input>

                    {!isSignin&&<Input ref={usernameRef} placeholder="Username" type="text" ></Input>}
